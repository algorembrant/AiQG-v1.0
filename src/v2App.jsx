...
const ALL_LLMS = [
  ...
  // Search & Research AI
  { id: 'perplexity', name: 'Perplexity AI', url: 'https://www.perplexity.ai/', icon: 'https://www.perplexity.ai/favicon.svg', category: 'Search' },
  { id: 'you', name: 'You.com', url: 'https://you.com/', icon: 'https://you.com/favicon.ico', category: 'Search' },
  { id: 'phind', name: 'Phind', url: 'https://www.phind.com/', icon: 'https://www.phind.com/images/favicon.png', category: 'Search' },
  { id: 'andi', name: 'Andi', url: 'https://andisearch.com/', icon: 'https://andisearch.com/favicon.ico', category: 'Search' },
  { id: 'metaphor', name: 'Metaphor', url: 'https://metaphor.systems/', icon: 'https://metaphor.systems/favicon.ico', category: 'Search' },
  { id: 'komo', name: 'Komo AI', url: 'https://komo.ai/', icon: 'https://komo.ai/favicon.ico', category: 'Search' },
  { id: 'consensus', name: 'Consensus', url: 'https://consensus.app/', icon: 'https://consensus.app/favicon.ico', category: 'Search' },
  { id: 'elicit', name: 'Elicit', url: 'https://elicit.com/', icon: 'https://elicit.com/favicon.ico', category: 'Search' },
  { id: 'scholarai', name: 'ScholarAI', url: 'https://scholar-ai.net/', icon: 'https://scholar-ai.net/favicon.ico', category: 'Search' },
  
  // Multi-Model Platforms
  { id: 'poe', name: 'Poe', url: 'https://poe.com/', icon: 'https://poe.com/poe_logos/App_Icon_Round_128.png', category: 'Multi-Model' },
  ...
  { id: 'forefront', name: 'Forefront', url: 'https://www.forefront.ai/', icon: 'https://www.forefront.ai/favicon.ico', category: 'Multi-Model' },
  ...
  { id: 'chathub', name: 'ChatHub', url: 'https://app.chathub.gg/', icon: 'https://app.chathub.gg/favicon.ico', category: 'Multi-Model' },
  
  // Open Source AI
  { id: 'llama', name: 'Meta AI', url: 'https://www.meta.ai/', icon: 'https://www.meta.ai/favicon.ico', category: 'Open Source' },
  { id: 'mistral', name: 'Mistral AI', url: 'https://chat.mistral.ai/', icon: 'https://chat.mistral.ai/favicon.ico', category: 'Open Source' },
  { id: 'deepseek', name: 'DeepSeek', url: 'https://chat.deepseek.com/', icon: 'https://chat.deepseek.com/favicon.ico', category: 'Open Source' },
  { id: 'lmsys', name: 'LMSYS Chat', url: 'https://chat.lmsys.org/', icon: 'https://chat.lmsys.org/favicon.ico', category: 'Open Source' },
  ...
  { id: 'tongyi', name: 'Tongyi Qianwen', url: 'https://tongyi.aliyun.com/', icon: 'https://img.alicdn.com/imgextra/i3/O1CN01dHhu5j1ZfTRfVH7RH_!!6000000003219-73-tps-64-64.ico', category: 'Chinese' },
  { id: 'chatglm', name: 'ChatGLM', url: 'https://chatglm.cn/', icon: 'https://chatglm.cn/favicon.ico', category: 'Chinese' },
  ...
  { id: 'sensechat', name: 'SenseChat', url: 'https://chat.sensetime.com/', icon: 'https://chat.sensetime.com/favicon.ico', category: 'Chinese' },
  { id: 'doubao', name: 'ByteDance Doubao', url: 'https://www.doubao.com/', icon: 'https://www.doubao.com/favicon.ico', category: 'Chinese' },
  ...
  // Specialized AI
  { id: 'character', name: 'Character.AI', url: 'https://character.ai/', icon: 'https://characterai.io/favicon.ico', category: 'Specialized' },
  { id: 'jasper', name: 'Jasper AI', url: 'https://www.jasper.ai/', icon: 'https://www.jasper.ai/favicon.ico', category: 'Specialized' },
  { id: 'writesonic', name: 'Writesonic', url: 'https://writesonic.com/', icon: 'https://writesonic.com/favicon.ico', category: 'Specialized' },
  { id: 'copy', name: 'Copy.ai', url: 'https://www.copy.ai/', icon: 'https://www.copy.ai/favicon.ico', category: 'Specialized' },
  { id: 'rytr', name: 'Rytr', url: 'https://rytr.me/', icon: 'https://rytr.me/favicon.ico', category: 'Specialized' },
  ...
  { id: 'aider', name: 'Aider', url: 'https://aider.chat/', icon: 'https://aider.chat/favicon.ico', category: 'Coding' },
  { id: 'v0', name: 'v0', url: 'https://v0.dev/', icon: 'https://v0.dev/favicon.ico', category: 'Coding' },
  { id: 'bolt', name: 'Bolt.new', url: 'https://bolt.new/', icon: 'https://bolt.new/favicon.ico', category: 'Coding' },
  { id: 'lovable', name: 'Lovable', url: 'https://lovable.dev/', icon: 'https://lovable.dev/favicon.ico', category: 'Coding' },
  
  // Regional AI
  { id: 'clova', name: 'Clova X', url: 'https://clova-x.naver.com/', icon: 'https://ssl.pstatic.net/static/clova/service/clova-x/static/favicon.ico', category: 'Regional' },
  { id: 'wrtn', name: 'Wrtn', url: 'https://wrtn.ai/', icon: 'https://wrtn.ai/favicon.ico', category: 'Regional' },
  { id: 'yandex', name: 'YandexGPT', url: 'https://ya.ru/', icon: 'https://ya.ru/favicon.ico', category: 'Regional' },
  { id: 'rinna', name: 'Rinna AI', url: 'https://www.rinna.jp/', icon: 'https://www.rinna.jp/favicon.ico', category: 'Regional' },
  { id: 'sakana', name: 'Sakana AI', url: 'https://sakana.ai/', icon: 'https://sakana.ai/favicon.ico', category: 'Regional' },
  { id: 'kakaobrain', name: 'KoGPT', url: 'https://www.kakaobrain.com/', icon: 'https://www.kakaobrain.com/favicon.ico', category: 'Regional' },
  ...
  // Creative AI
  { id: 'midjourney', name: 'Midjourney', url: 'https://www.midjourney.com/', icon: 'https://www.midjourney.com/favicon.ico', category: 'Creative' },
    ...
    <div className="flex h-screen bg-white text-gray-900">
      <div className={`${showSidebar ? 'w-80' : 'w-0'} transition-all duration-300 border-r border-gray-200 flex flex-col overflow-hidden`}>
        <div className="p-4 border-b border-gray-200">
          ...
          <p className="text-xs text-gray-500 mt-1">{ALL_LLMS.length} platforms</p>
        </div>
            ...
            {filteredLLMs.map(llm => (
              ...
              >
                <div className="flex items-center gap-3">
                  <img src={llm.icon} alt={llm.name} className="w-8 h-8 rounded-lg" onError={(e) => e.target.style.display = 'none'} />
          ...
          {activeLLMs.length === 0 ? (
            <div className="h-full flex items-center justify-center text-gray-400">
              <div className="text-center">
                ...
                <p className="text-sm mt-2">Drag from the sidebar to start</p>
              </div>
            </div>
          ) : (
                ...
                <div key={llm.id} className="relative border border-gray-200 rounded-lg overflow-hidden bg-white flex flex-col">
                  <div className="h-12 flex items-center justify-between px-4 border-b border-gray-200 bg-gray-50">
                    <div className="flex items-center gap-2">
                      <img src={llm.icon} alt={llm.name} className="w-5 h-5 rounded" onError={(e) => e.target.style.display = 'none'} />
